...
- **Emplacement requis** : Ces fichiers doivent se trouver à la racine du dossier `Projet_8`.
...
2.  **Structure des Fichiers** : Avant de lancer le script, assurez-vous que votre dossier `Projet_8` est structuré comme suit :
    ```
    Projet_8/
